...
from numpy import argsort, array, concatenate, dtype, ndarray, abs, argmax, argmin
...
class LinearSpectraStitch(SpectraStitch):
    ...
    def _stitch_spectra(self, spectrum1: List[List[float]], spectrum2: List[List[float]]) -> List[List[float]]:
        ...
        # Finds the index of the largest element in the first spectrum that is less than the first element in the second spectrum
